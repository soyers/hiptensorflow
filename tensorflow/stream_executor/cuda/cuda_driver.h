...
class CUDADriver {
 public:
  ...
  static bool SynchronousMemsetUint8(CudaContext* context, void* location,
  ...
  static bool AsynchronousMemsetUint8(CudaContext* context, void* location,
  ...
  static port::StatusOr<MemorySpace> GetPointerMemorySpace(void* pointer);
