...
class CUDADriver {
 public:
  ...
  static port::StatusOr<hipDevice_t> DeviceFromContext(CudaContext* context);
  ...
  static bool CreateStream(CudaContext* context, hipStream_t *stream);
  ...
  static void DestroyStream(CudaContext* context, hipStream_t *stream);
  ...
  // http://docs.nvidia.com/cuda/cuda-driver-api/group__CUDA__EVENT.html#group__CUDA__EVENT_1g450687e75f3ff992fe01662a43d9d3db
  static port::Status CreateEvent(CudaContext* context, hipEvent_t *result,
                                  EventFlags flags);
  ...
  static port::Status DestroyEvent(CudaContext* context, hipEvent_t *event);
  ...
  // the CUDA driver API.
  static port::Status GetDevice(hipDevice_t *device);
  ...
  /*static bool FuncGetAttribute(hipFunction_attribute attribute,
  ...
  static bool LaunchKernel(CudaContext* context, hipFunction_t function,
  ...
  static bool GetModuleFunction(CudaContext* context, hipModule_t module,
  ...
  static bool GetModuleSymbol(CudaContext* context, hipModule_t module,
  ...
  static void UnloadModule(CudaContext* context, hipModule_t module);
  ...
  static bool SynchronousMemsetUint8(CudaContext* context, hipDeviceptr_t location,
  ...
  static bool AsynchronousMemsetUint8(CudaContext* context, hipDeviceptr_t location,
  ...
  static bool SynchronousMemcpyH2D(CudaContext* context, hipDeviceptr_t gpu_dst,
                                   const void *host_src, uint64 size);
  static bool SynchronousMemcpyD2D(CudaContext* context, hipDeviceptr_t gpu_dst,
                                   hipDeviceptr_t gpu_src, uint64 size);
  ...
  static bool AsynchronousMemcpyD2H(CudaContext* context, void *host_dst,
                                    hipDeviceptr_t gpu_src, uint64 size,
                                    hipStream_t stream);
  static bool AsynchronousMemcpyH2D(CudaContext* context, hipDeviceptr_t gpu_dst,
                                    const void *host_src, uint64 size,
                                    hipStream_t stream);
  static bool AsynchronousMemcpyD2D(CudaContext* context, hipDeviceptr_t gpu_dst,
                                    hipDeviceptr_t gpu_src, uint64 size,
                                    hipStream_t stream);
  ...
  // details.
  static bool AddStreamCallback(CudaContext* context, hipStream_t stream,
  ...
  static bool WaitStreamOnEvent(CudaContext* context, hipStream_t stream,
                                hipEvent_t event);
  ...
  static bool SynchronizeStream(CudaContext* context, hipStream_t stream);
  ...
  static bool IsStreamIdle(CudaContext* context, hipStream_t stream);

  // Returns whether code in the from context can access memory in the to
  // context via hipDevice_tCanAccessPeer.
  ...
  static port::Status RecordEvent(CudaContext* context, hipEvent_t event,
                                  hipStream_t stream);
  ...
  static port::StatusOr<hipError_t> QueryEvent(CudaContext* context,
                                             hipEvent_t event);

  // -- Pointer-specific calls.

  // Returns the context in which pointer was allocated or registered.
  static port::StatusOr<CudaContext*> GetPointerContext(hipDeviceptr_t pointer);
  ...
  // Queries the grid limits for device with hipDevice_tGetAttribute calls.
  ...
  // structure for device_ordinal via hipDevice_tGetProperties.
  ...
  // hipDevice_tGetattribute with CU_DEVICE_ATTRIBUTE_ECC_ENABLED.
  // http://docs.nvidia.com/cuda/cuda-driver-api/group__CUDA__DEVICE.html#group__CUDA__DEVICE_1g9c3e1414f0ad901d3278a4d6645fc266
  ...
  // context, in bytes, via hipDevice_tTotalMem.
  ...
  // Returns the number of visible CUDA device via hipDevice_tGetCount.
...
class CudaContext {
 public:
  CudaContext(hipCtx_t context, int64 id) : context_(context), id_(id) { }
